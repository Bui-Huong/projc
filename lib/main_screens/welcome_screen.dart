...
import 'package:multi_store_app/widgets/orange_button.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(
                height: 120,
                width: 200,
                child: Image(image: AssetImage('images/inapp/zyro-image.png')),
              ),
              SizedBox(
                height: 80,
...
class AnimatedLogo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      child: const Image(image: AssetImage('images/inapp/zyro-image.png')),
    );
  }
}
